...
//
//public class ActivityTrainingOnMap extends AppCompatActivity {
//
...
//        setContentView(R.layout.activity_training_on_map);
//
...
//
//        final Training training = (Training) intent.getSerializableExtra(ActivityTraining.PAYLOAD_TRAINING_KEY);
//        final String locationUuid = training.getLocationUuid();
//
...
//                    selectedFloorUuid = selectedFloor.getUuid();
//                    trainingView.init(location, selectedFloor, training);
//                }
//
