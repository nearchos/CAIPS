...
public class ActivityEditFloor extends AppCompatActivity {
...
//    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        final String floorUUID = intent.getStringExtra(INTENT_EXTRA_FLOOR_UUID_KEY);
        Log.d(TAG, "floorUUID: " + floorUUID);
        uuidEditText.setText(floorUUID);
        ...
        uuidEditText.setText(floor.getUuid());
        locationEditText.setText(floor.getLocationUUID());
        ...
        Log.d(TAG, "Updating UI for: " + floor.toFullString());
    }
    ...
    public void editTopLeft(View view) {
        ...
        Log.d(TAG, "topLeftLat: " + topLeftLat + ", topLeftLng: " + topLeftLng);
    ...
    public void editBottomRight(View view) {
        ...
        Log.d(TAG, "bottomRightLat: " + bottomRightLat + ", bottomRightLng: " + bottomRightLng);
    ...
    public void save(View view) {
        ...
        DatabaseHelper.edit(sqLiteDatabase, uuidEditText.getText().toString(), nameEditText.getText().toString(), seq,
                    imageUuidEditText.getText().toString(), topLeftLat, topLeftLng, bottomRightLat, bottomRightLng);
        Log.d(TAG, "Edited existing floor: " + uuidEditText.getText().toString());
