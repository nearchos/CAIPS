...
public class ActivitySelectCoordinates extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnCameraChangeListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final double initialLat = getIntent().getDoubleExtra(INTENT_EXTRA_INITIAL_LAT_KEY, 35.1401d);
        final double initialLng = getIntent().getDoubleExtra(INTENT_EXTRA_INITIAL_LNG_KEY, 33.3748d);
